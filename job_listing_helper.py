...
embedding_of_query = llm.embed_query(query)

# Search the vector database for documents similar to the query embedding
docs = vector_db.similarity_search_by_vector(embedding_of_query)

# Iterate through the retrieved similar documents
for doc in docs:
    # Print the content of each similar document
